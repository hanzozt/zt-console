...
ziti-console-lib is a shared Angular library that exports components used to administrate an <a href="https://hanzozt.dev">Hanzo ZT Network</a>

This library is imported and extended via the <a href="https://github.com/hanzozt/ziti-console">Ziti Admin Console</a>, but can also be used in other 3rd party Angular applications.
...
```bash
npm install @hanzozt/ziti-console-lib
```
...
After checking out the main <a href="https://github.com/hanzozt/ziti-console">ziti-console</a> github project,
