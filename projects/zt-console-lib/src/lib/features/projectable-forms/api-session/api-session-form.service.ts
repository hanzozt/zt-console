...
export class APISessionFormService {
    ...
    save(formData): Promise<any> {
        ...
        return svc('transit-routers', data, formData.id).then(async (result: any) => {
            ...
            let router = await this.ztService.getSubdata('transit-routers', id, '').then((routerData) => {
    ...
    getAuthPolicies() {
        ...
        return this.ztService.get('auth-policies', paging, []).then((result: any) => {
    ...
    getAssociatedServices(id) {
        this.ztService.getSubdata('transit-routers', id, 'services').then((result: any) => {
    ...
    getAssociatedIdentities(id) {
        this.ztService.getSubdata('transit-routers', id, 'identities').then((result: any) => {
