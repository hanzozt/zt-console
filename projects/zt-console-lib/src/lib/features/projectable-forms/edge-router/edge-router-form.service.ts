...
export class EdgeRouterFormService {
    ...
    save(formData): Promise<any> {
        ...
        return svc('edge-routers', data, formData.id).then(async (result: any) => {
            ...
            let router = await this.ztService.getSubdata('edge-routers', id, '').then((routerData) => {
    ...
    getAssociatedServices(id) {
        this.ztService.getSubdata('edge-routers', id, 'services').then((result: any) => {
    ...
    getAssociatedIdentities(id) {
        this.ztService.getSubdata('edge-routers', id, 'identities').then((result: any) => {
