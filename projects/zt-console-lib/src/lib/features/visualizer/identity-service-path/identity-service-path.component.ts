...
export class IdentityServicePathComponent implements OnInit {
      ...
      .then((result) => {
        ...
        if (!this.services || this.services.length === 0) {
          ...
          for (let page = 2; page <= pages; page++) {
            ...
            const tmp_promise = this.ztService
              .get(
  ...
  serviceChanged() {
     ...
     const configPromise = this.ztService
      .get(configs_url, {}, [])
      .then((configs) => {
